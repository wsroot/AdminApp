...
namespace SmartSql
{
    public class SmartSqlMapper : ISmartSqlMapper
    {
        ...
        public IDbConnectionSessionStore SessionStore => SmartSqlOptions.DbSessionStore;
        public IDataSourceFilter DataSourceFilter => SmartSqlOptions.DataSourceFilter;
        public IConfigLoader ConfigLoader => SmartSqlOptions.ConfigLoader;
        public ICommandExecuter CommandExecuter => SmartSqlOptions.CommandExecuter;
        public IDataReaderDeserializerFactory DeserializerFactory => SmartSqlOptions.DataReaderDeserializerFactory;
        public ILoggerFactory LoggerFactory => SmartSqlOptions.LoggerFactory;
        public ICacheManager CacheManager => SmartSqlOptions.CacheManager;
        public ISqlBuilder SqlBuilder => SmartSqlOptions.SqlBuilder;
